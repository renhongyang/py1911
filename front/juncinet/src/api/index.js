...
export const getTimegoodsDetail = (param)=>{
	return axios.get(`/api/v1/timegoods/${param.id}`)
};

export const getIndexgoodsDetail = (param)=>{
	return axios.get(`/api/v1/indexgoods/${param.id}`)
};
